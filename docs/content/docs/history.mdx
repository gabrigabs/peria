...
- Subject: feat(github): add auth diagnostics
- Author: Gabriel Bezerra Rodrigues &lt;gabrielbrodrigues1@gmail.com&gt;
- Authored at: 2026-06-29T12:12:02-03:00
...
- `M packages/core/src/scanner/git.ts`
- `M packages/core/src/scanner/index.ts`
- `M packages/core/src/types/graph.ts`
- `M packages/core/src/types/manifest.ts`
- `M packages/core/src/wiki/collectors/git.ts`
