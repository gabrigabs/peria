...
| --- | --- | --- |
| apiReference | disabled | `peria.config.ts:101` |
| changeMap | disabled | `peria.config.ts:109` |
| codeMap | enabled | `peria.config.ts:96` |
| contextPacks | disabled | `peria.config.ts:103` |
| driftCheck | enabled | `peria.config.ts:102` |
| embeddedDocs | enabled | `peria.config.ts:95` |
| embeddedDocsAdapters | disabled | `peria.config.ts:105` |
| gitDiff | disabled | `peria.config.ts:108` |
| github | disabled | `peria.config.ts:111` |
| llms | enabled | `peria.config.ts:98` |
| mermaid | disabled | `peria.config.ts:104` |
| patchNotes | disabled | `peria.config.ts:110` |
| wiki | enabled | `peria.config.ts:97` |
