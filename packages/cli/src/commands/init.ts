...
import { detectEntrypoint, detectFramework, type Framework } from '@peria/core';
import chalk from 'chalk';
import { generateConfig, writeConfigFile } from '../generators/config.js';
import { promptEntrypoint } from '../prompts/entrypoint.js';
import { getFeatureSummary, promptFeatures } from '../prompts/features.js';
...
export { detectEntrypoint, detectFramework };
